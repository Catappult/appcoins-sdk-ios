#
#  Be sure to run `pod spec lint AppCoinsSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AppCoinsSDK"
  spec.version      = "1.3.1"
  spec.summary      = "The iOS Billing SDK is a simple solution to implement Catappult billing. It consists of a Billing client that uses an AppCoins Wallet integration and allows you to get your products from Catappult and process the purchase of those items."
  ...
  spec.homepage     = "https://github.com/Catappult/appcoins-sdk-ios"
  ...
  spec.author             = "Aptoide S.A."
  # Or just: spec.author    = "tiaguu"
  # spec.authors            = { "tiaguu" => "tiagogteodoro@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/tiaguu"
