...
internal protocol AuthRepositoryProtocol {
    ...
    func logout()
    func deleteAccount(email: String, completion: @escaping (Result<Bool, AuthError>) -> Void)
    func confirmDeleteAccount(code: String, completion: @escaping (Result<Bool, AuthError>) -> Void)
