...
internal class ProductRepository: ProductRepositoryProtocol {
    ...
    internal func getProduct(
        ...
        completion: @escaping (Result<Product, ProductServiceError>) -> Void
    ) {
            ...
            case .success(let productRaw):
                if let productRaw = productRaw {
                    ...
                    completion(.failure(.failed(
                        ...
                        description: "Product not found at ProductRepository.swift:getProduct", request: nil
                    )))
                }
