...
internal struct BottomSheetPresenter: UIViewControllerRepresentable {
    @Binding var isPresented: Bool

    func makeUIViewController(context: Context) -> PassthroughViewController {
    ...
    func updateUIViewController(_ uiViewController: PassthroughViewController, context: Context) {
