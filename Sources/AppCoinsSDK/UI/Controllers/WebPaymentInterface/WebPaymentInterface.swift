...
internal class WebPaymentInterface: NSObject, WKScriptMessageHandler {
    ...
    internal func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        Utils.log("SDK received message with body: \(obfuscateFields(["authToken", "refreshToken"], in: message.body))")
        ...
        case .handleApplicationRedirect:
            do {
                let handleApplicationRedirectBody = try JSONDecoder().decode(HandleApplicationRedirectBody.self, from: params)
