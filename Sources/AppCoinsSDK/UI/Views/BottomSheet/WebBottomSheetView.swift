...
struct WebBottomSheetView: UIViewRepresentable {
    ...
    func updateUIView(_ webView: WKWebView, context: Context) {
        ...
        if let URL = URL(string: "https://wallet.dev.appcoins.io/iap/sdk?origin=BDS&type=INAPP&domain=com.appcoins.trivialdrivesample.test&product=antifreeze&country=PT&guest_id=\(guestUID)&version=33&lang_code=PT_pt&payment_channel=ios_sdk"),
            webView.url != URL {
