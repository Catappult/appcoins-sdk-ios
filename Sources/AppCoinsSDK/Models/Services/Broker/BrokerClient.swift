...
internal class BrokerClient : BrokerService {
    
    private let endpoint: String
    
    internal init(endpoint: String = BuildConfiguration.brokerServiceURL) {
        self.endpoint = endpoint
    }
    
    internal func convertCurrency(money: String, fromCurrency: Currency, toCurrency: Currency?, result: @escaping (Result<ConvertCurrencyRaw, BrokerError>) -> Void) {
    ...
    internal func getSupportedCurrencies(result: @escaping (Result<[CurrencyRaw], BrokerError>) -> Void) {
