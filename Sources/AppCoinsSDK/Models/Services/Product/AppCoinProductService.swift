...
internal protocol AppCoinProductService {
    ...
    func getProductInformation(domain: String, currency: Currency, result: @escaping (Result<GetProductInformationRaw, ProductServiceError>) -> Void)
    
    func getProductInformation(domain: String, sku: String, currency: Currency, result: @escaping (Result<GetProductInformationRaw, ProductServiceError>) -> Void)
