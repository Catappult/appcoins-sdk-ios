...
internal protocol AppCoinProductService {
    ...
    func getProductInformation(domain: String, result: @escaping (Result<[ProductRaw], ProductServiceError>) -> Void)
    
    func getProductInformation(domain: String, sku: String, result: @escaping (Result<ProductRaw?, ProductServiceError>) -> Void)
